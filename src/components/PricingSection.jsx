      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-600 mb-10 max-w-2xl">
            Most popular plans for small and medium businesses or you can select your own plan options below
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {packages.map((pkg, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="h-full rounded-xl border-0 border-b-8 border-solid border-[#C95B5B]">
                <CardHeader className="pb-2">
                  <div className="flex items-center">
                    <div className="bg-[#C95B5B] p-1.5 rounded">
                    ...
                    <span className="text-sm font-medium py-1.5 px-2 rounded bg-gray-50">{pkg.type}</span>
                  </div>
                ...
                <CardFooter className="flex flex-col items-start pt-4">
                  <div className="flex items-baseline gap-1">
                    <span className="text-gray-400 text-3xl font-bold">USD</span>
