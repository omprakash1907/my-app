            ...
            >
              <div>
                ...
                <div className="flex gap-4 items-center justify-end mt-8">
                  <Button className="bg-[#006400] hover:bg-[#005500] text-white px-10 py-6 font-medium">Start</Button>
                </div>
              </div>
              <div className="ml-4">
                <a href="#" className="flex items-center text-[#333333] hover:text-[#00205B] transition-colors mt-4 ms-8">
                  <span className="mr-2">Explore all plans</span>
                  <svg width="13" height="18" viewBox="0 0 13 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12.3371 11.266C11.9801 10.909 11.4021 10.909 11.0451 11.266L7.47905 14.823V0.917007C7.47905 0.413007 7.06606 0 6.56206 0C6.05806 0 5.64507 0.413007 5.64507 0.917007V14.832L2.08907 11.275C1.73107 10.918 1.15407 10.918 0.79607 11.275C0.43907 11.633 0.43907 12.21 0.79607 12.568L5.92006 17.692C6.27806 18.05 6.85506 18.05 7.21306 17.692L12.3371 12.568C12.6851 12.21 12.6851 11.624 12.3371 11.266Z" fill="#333333" />
                  </svg>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.div variants={item}>
              <Card className="h-full bg-[#444444] text-white border-none shadow-lg rounded-md overflow-hidden hover:transform hover:scale-[1.01] transition-all cursor-pointer">
                <CardHeader>
                  <CardTitle className="text-3xl font-medium">Buy Subscriptions</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            {/* Why Us? Card */}
            <motion.div variants={item}>
              <Card className="h-full bg-white border-none shadow-lg rounded-md overflow-hidden hover:transform hover:scale-[1.01] transition-all cursor-pointer">
                <CardHeader>
                  <CardTitle className="text-xl font-medium text-[#333333]">Why Us?</CardTitle>
                </CardHeader>
            ...
            <motion.div variants={item}>
              <Card className="h-full bg-[#333333] text-white border-none shadow-lg rounded-md overflow-hidden hover:transform hover:scale-[1.01] transition-all cursor-pointer">
                <CardHeader>
